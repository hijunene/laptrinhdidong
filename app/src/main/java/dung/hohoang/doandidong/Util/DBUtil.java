...
public class DBUtil {
    ...
    public static final String CREATE_TABLE_FOOD_TYPE = "CREATE TABLE IF NOT EXISTS foodtype(id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(50) NOT NULL, image VARCHAR(300))";
